...
<style type="text/css">
	...
	<div class="flex-container m50">
                ...
                <div class="container m50">
                	...
                	<!-- 배송지 정보 -->
                	<div class= "row m20 mt20">
                		<h2>배송지 정보</h2>
                	</div>
                	<div class="float-container b-gr p10">
	                		<div class="float-container">
	                			<div class="float-left layer-5"><h3>수령인</h3></div>
	                			<div class="float-left layer-4"><p><%=fundingDto.getFundingGetter()%></p></div>
	                		</div>
	                		<div class="float-container">
	                			<div class="float-left layer-5 mt10"><h3>연락처</h3></div>
	                			<div class="float-left layer-4 mt10"><p><%=fundingDto.getFundingPhone()%></p></div>
	                		</div>
	                		<div class="float-container">
	                			<div class="float-left layer-5 mt10"><h3>배송지</h3></div>
	                			<div class="float-left layer-4 mt10">
	                				<p><%=fundingDto.getFundingPost()%></p>
	                				<p class="mt5"><%=fundingDto.getFundingBasicAddress()%></p>
	                				<p class="mt5"><%=fundingDto.getFundingDetailAddress()%></p>
	                			</div>
	                		</div>
	                		<div class="float-container">
	                			<div class="float-left layer-5 mt10"><h3>배송메모</h3></div>
	                			<div class="float-left layer-4 mt10">
		                				<%if(fundingDto.getFundingPostMessage() == null) { %>
		                					<p></p>		                					
		                				<%} else { %>
		                					<p><%=fundingDto.getFundingPostMessage() %></p>
		                				<%} %>
	                			</div>
	                		</div>
	                	</div>
