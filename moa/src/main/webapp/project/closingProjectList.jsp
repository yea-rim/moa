...
<%-- 
	마감된 펀딩목록
	마감된 펀딩목록에는 정렬기준에 마감임박이 없으며, closingSelectList() 메소드를 사용
	메소드는 정렬기준이 다르고 마감임박은 sort에서 제외  
--%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>moa 마감된 펀딩목록</title>
...
<body>
	...
	<div class="container w1000">
		...
		<%-- 카테고리 선택창 --%>
		<a href="closingProjectList.jsp">전체</a> <a
			href="closingProjectList.jsp?type=project_category&keyword=패션/잡화">패션/잡화</a>
		<a href="closingProjectList.jsp?type=project_category&keyword=뷰티">뷰티</a> <a
			href="closingProjectList.jsp?type=project_category&keyword=푸드">푸드</a> <a
			href="closingProjectList.jsp?type=project_category&keyword=홈/리빙">홈/리빙</a> <a
			href="closingProjectList.jsp?type=project_category&keyword=테크/가전">테크/가전</a>
		<a href="closingProjectList.jsp?type=project_category&keyword=기타">기타</a>
		...
		if (isSearch) {
		%>
		<form action="closingProjectList.jsp" method="get">
