			...
			<table class="table table-a">
				<tbody>
					<tr>
						<th>제목</th>
						<td>
							<input type="text" class="form-input fill progress-title" name="progressTitle" placeholder="제목을 입력해주세요" autocomplete="off">
						</td>
					</tr>
					<tr>
						<th style="vertical-align: middle">공지내용</th>
						<td>
							<textarea rows="5" class="form-input fill progress-content" name="progressContent" placeholder="내용을 입력해주세요"></textarea>
						</td>
					</tr>
					<tr>
						<th>첨부파일</th>
