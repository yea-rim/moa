	...
	<form action="insert.do" method="post" enctype="multipart/form-data" class="insert-form">
		...
		<div class="container w600 m30 page">
			...
			<div class="row m20">
				...
				data-success-msg="" data-fail-msg="50자 이내로 입력해주세요." value="<%=projectDto.getProjectName()%>">
			...
			<div class="row m20">
				...
				data-success-msg="" data-fail-msg="200자 이내로 입력해주세요."><%=projectDto.getProjectSummary()%></textarea>
				<div class="flex-container length">
					<div class="left-wrapper msg f12 red"></div>
