...
project_seller_no references seller(seller_no) on delete set null,
project_category varchar2(15) not null check(project_category in('패션/잡화','뷰티','푸드','홈/리빙','테크/가전','기타')),
...
project_permission char(1) default 0 check(project_permission in(0, 1)) not null,
