...
notice_writer references admin(admin_id) on delete set null not null,
...
notice_no references moa_notice(notice_no) on delete cascade,
...
member_no references member(member_no) on delete set null not null,
...
question_no references moa_question(question_no) on delete cascade,
attach_no references attach(attach_no) on delete cascade
);
